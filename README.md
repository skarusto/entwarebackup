...
3. (необязательно) Добавлена секция #Router settings, чтобы можно было задать переменную ROUTER_NAME, которая будет использоваться при генерации имени файла бэкапа.
